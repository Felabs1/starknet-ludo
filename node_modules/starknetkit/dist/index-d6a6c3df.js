...
var we = (i, e, t) => ($u(i, typeof e != "symbol" ? e + "" : e, t), t);
...
import { a as Uu } from "./index-4112b556.js";
...
***************************************************************************** */
(function(i) {
  var e, t, s, r, n, o, c, u, d, p, b, D, x, E, C, F, K, I, O, y, w, f, a;
  (function(l) {
...
var mi = {}, mr = {}, bi = {}, Zn;
function Xu() {
  return Zn || (Zn = 1, Object.defineProperty(bi, "__esModule", { value: !0 }), bi.ONE_THOUSAND = bi.ONE_HUNDRED = void 0, bi.ONE_HUNDRED = 100, bi.ONE_THOUSAND = 1e3), bi;
}
var br = {}, eo;
function Zu() {
...
function cl() {
  if (ho)
    return wi;
  ho = 1, Object.defineProperty(wi, "__esModule", { value: !0 }), wi.HEARTBEAT_EVENTS = wi.HEARTBEAT_INTERVAL = void 0;
  const i = V;
...
function ul() {
  ...
  function e(t, s, r) {
    ...
    if (p === 0)
      return t;
    for (var b = "", D = 1 - o, x = -1, E = t && t.length || 0, C = 0; C < E; ) {
      if (t.charCodeAt(C) === 37 && C + 1 < E) {
        switch (x = x > -1 ? x : 0, t.charCodeAt(C + 1)) {
          ...
          case 102:
            if (D >= p || s[D] == null)
              break;
            x < C && (b += t.slice(x, C)), b += Number(s[D]), x = C + 2, C++;
            break;
          case 105:
            if (D >= p || s[D] == null)
              break;
            x < C && (b += t.slice(x, C)), b += Math.floor(Number(s[D])), x = C + 2, C++;
            break;
          case 79:
          case 111:
          case 106:
          ...
          case 115:
            if (D >= p)
              break;
            x < C && (b += t.slice(x, C)), b += String(s[D]), x = C + 2, C++;
            break;
          case 37:
            x < C && (b += t.slice(x, C)), b += "%", x = C + 2, C++, D--;
            break;
        }
        ++D;
      }
    ...
    return x === -1 ? t : (x < E && (b += t.slice(x)), b);
  }
  return Er;
}
var Sr, po;
...
(function(i) {
  Object.defineProperty(i, "__esModule", { value: !0 });
  function e(c, u) {
    var d = c >>> 16 & 65535, p = c & 65535, b = u >>> 16 & 65535, D = u & 65535;
    return p * D + (d * D + p * b << 16 >>> 0) | 0;
  }
  i.mul = Math.imul || e;
  function t(c, u) {
    return c + u | 0;
...
(function(i) {
  ...
  var s = (
    ...
    function() {
      ...
      return c.prototype._initState = function() {
        ...
        if (!this._finished) {
          var d = this._bytesHashed, p = this._bufferLength, b = d / 536870912 | 0, D = d << 3, x = d % 128 < 112 ? 128 : 256;
          this._buffer[p] = 128;
          for (var E = p + 1; E < x - 8; E++)
            this._buffer[E] = 0;
          e.writeUint32BE(b, this._buffer, x - 8), e.writeUint32BE(D, this._buffer, x - 4), n(this._tempHi, this._tempLo, this._stateHi, this._stateLo, this._buffer, 0, x), this._finished = !0;
        }
  ...
  function n(c, u, d, p, b, D, x) {
    for (var E = d[0], C = d[1], F = d[2], K = d[3], I = d[4], O = d[5], y = d[6], w = d[7], f = p[0], a = p[1], l = p[2], L = p[3], v = p[4], R = p[5], $ = p[6], q = p[7], m, _, B, z, j, U, M, H; x >= 128; ) {
      ...
      m = E, _ = f, j = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[0], _ = p[0], j += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j >>> 16, M += U >>> 16, H += M >>> 16, d[0] = E = M & 65535 | H << 16, p[0] = f = j & 65535 | U << 16, m = C, _ = a, j = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[1], _ = p[1], j += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j >>> 16, M += U >>> 16, H += M >>> 16, d[1] = C = M & 65535 | H << 16, p[1] = a = j & 65535 | U << 16, m = F, _ = l, j = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[2], _ = p[2], j += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j >>> 16, M += U >>> 16, H += M >>> 16, d[2] = F = M & 65535 | H << 16, p[2] = l = j & 65535 | U << 16, m = K, _ = L, j = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[3], _ = p[3], j += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j >>> 16, M += U >>> 16, H += M >>> 16, d[3] = K = M & 65535 | H << 16, p[3] = L = j & 65535 | U << 16, m = I, _ = v, j = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[4], _ = p[4], j += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j >>> 16, M += U >>> 16, H += M >>> 16, d[4] = I = M & 65535 | H << 16, p[4] = v = j & 65535 | U << 16, m = O, _ = R, j = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[5], _ = p[5], j += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j >>> 16, M += U >>> 16, H += M >>> 16, d[5] = O = M & 65535 | H << 16, p[5] = R = j & 65535 | U << 16, m = y, _ = $, j = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[6], _ = p[6], j += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j >>> 16, M += U >>> 16, H += M >>> 16, d[6] = y = M & 65535 | H << 16, p[6] = $ = j & 65535 | U << 16, m = w, _ = q, j = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[7], _ = p[7], j += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j >>> 16, M += U >>> 16, H += M >>> 16, d[7] = w = M & 65535 | H << 16, p[7] = q = j & 65535 | U << 16, D += 128, x -= 128;
    }
    return D;
  }
  function o(c) {
...
(function(i) {
  ...
  function _(T, A) {
    const N = [r(), r(), r(), r()];
    x(N[0], p), x(N[1], b), x(N[2], c), a(N[3], p, b), m(T, N, A);
  }
  function B(T) {
  ...
  function G(T, A) {
    ...
    return x(T[2], c), y(T[1], A), l(S, T[1]), a(W, S, u), f(S, S, T[2]), w(W, T[2], W), l(X, W), l(fe, X), a(ve, fe, X), a(N, ve, S), a(N, N, W), v(N, N), a(N, N, S), a(N, N, W), a(N, N, W), a(T[0], N, W), l(h, T[0]), a(h, h, W), I(h, S) && a(T[0], T[0], D), l(h, T[0]), a(h, h, W), I(h, S) ? -1 : (O(T[0]) === A[31] >> 7 && f(T[0], o, T[0]), a(T[3], T[0], T[1]), 0);
  }
  function ie(T, A, N) {
...
const sd = "EdDSA", rd = "JWT", bc = ".", wc = "base64url", nd = "utf8", od = "utf8", ad = ":", cd = "did", hd = "key", bo = "base58btc", ud = "z", ld = "K36", dd = 32;
function on(i) {
...
function fd(i, e) {
  ...
  function b(E) {
    ...
    for (var O = (I - K) * p + 1 >>> 0, y = new Uint8Array(O); K !== I; ) {
      for (var w = E[K], f = 0, a = O - 1; (w !== 0 || f < F) && a !== -1; a--, f++)
...
function Hs(i) {
  return Ne(Ce(sr(i), nd), wc);
}
function an(i) {
  const e = Ce(ld, bo), t = ud + Ne(ls([e, i]), bo);
...
function lf(i) {
  return Ce([Hs(i.header), Hs(i.payload)].join(bc), od);
}
function df(i) {
  return [
    Hs(i.header),
...
function pf(i, e, t) {
  for (var s = 1634760805, r = 857760878, n = 2036477234, o = 1797285236, c = t[3] << 24 | t[2] << 16 | t[1] << 8 | t[0], u = t[7] << 24 | t[6] << 16 | t[5] << 8 | t[4], d = t[11] << 24 | t[10] << 16 | t[9] << 8 | t[8], p = t[15] << 24 | t[14] << 16 | t[13] << 8 | t[12], b = t[19] << 24 | t[18] << 16 | t[17] << 8 | t[16], D = t[23] << 24 | t[22] << 16 | t[21] << 8 | t[20], x = t[27] << 24 | t[26] << 16 | t[25] << 8 | t[24], E = t[31] << 24 | t[30] << 16 | t[29] << 8 | t[28], C = e[3] << 24 | e[2] << 16 | e[1] << 8 | e[0], F = e[7] << 24 | e[6] << 16 | e[5] << 8 | e[4], K = e[11] << 24 | e[10] << 16 | e[9] << 8 | e[8], I = e[15] << 24 | e[14] << 16 | e[13] << 8 | e[12], O = s, y = r, w = n, f = o, a = c, l = u, L = d, v = p, R = b, $ = D, q = x, m = E, _ = C, B = F, z = K, j = I, U = 0; U < ff; U += 2)
    O = O + a | 0, _ ^= O, _ = _ >>> 32 - 16 | _ << 16, R = R + _ | 0, a ^= R, a = a >>> 32 - 12 | a << 12, y = y + l | 0, B ^= y, B = B >>> 32 - 16 | B << 16, $ = $ + B | 0, l ^= $, l = l >>> 32 - 12 | l << 12, w = w + L | 0, z ^= w, z = z >>> 32 - 16 | z << 16, q = q + z | 0, L ^= q, L = L >>> 32 - 12 | L << 12, f = f + v | 0, j ^= f, j = j >>> 32 - 16 | j << 16, m = m + j | 0, v ^= m, v = v >>> 32 - 12 | v << 12, w = w + L | 0, z ^= w, z = z >>> 32 - 8 | z << 8, q = q + z | 0, L ^= q, L = L >>> 32 - 7 | L << 7, f = f + v | 0, j ^= f, j = j >>> 32 - 8 | j << 8, m = m + j | 0, v ^= m, v = v >>> 32 - 7 | v << 7, y = y + l | 0, B ^= y, B = B >>> 32 - 8 | B << 8, $ = $ + B | 0, l ^= $, l = l >>> 32 - 7 | l << 7, O = O + a | 0, _ ^= O, _ = _ >>> 32 - 8 | _ << 8, R = R + _ | 0, a ^= R, a = a >>> 32 - 7 | a << 7, O = O + l | 0, j ^= O, j = j >>> 32 - 16 | j << 16, q = q + j | 0, l ^= q, l = l >>> 32 - 12 | l << 12, y = y + L | 0, _ ^= y, _ = _ >>> 32 - 16 | _ << 16, m = m + _ | 0, L ^= m, L = L >>> 32 - 12 | L << 12, w = w + v | 0, B ^= w, B = B >>> 32 - 16 | B << 16, R = R + B | 0, v ^= R, v = v >>> 32 - 12 | v << 12, f = f + a | 0, z ^= f, z = z >>> 32 - 16 | z << 16, $ = $ + z | 0, a ^= $, a = a >>> 32 - 12 | a << 12, w = w + v | 0, B ^= w, B = B >>> 32 - 8 | B << 8, R = R + B | 0, v ^= R, v = v >>> 32 - 7 | v << 7, f = f + a | 0, z ^= f, z = z >>> 32 - 8 | z << 8, $ = $ + z | 0, a ^= $, a = a >>> 32 - 7 | a << 7, y = y + L | 0, _ ^= y, _ = _ >>> 32 - 8 | _ << 8, m = m + _ | 0, L ^= m, L = L >>> 32 - 7 | L << 7, O = O + l | 0, j ^= O, j = j >>> 32 - 8 | j << 8, q = q + j | 0, l ^= q, l = l >>> 32 - 7 | l << 7;
  pt.writeUint32LE(O + s | 0, i, 0), pt.writeUint32LE(y + r | 0, i, 4), pt.writeUint32LE(w + n | 0, i, 8), pt.writeUint32LE(f + o | 0, i, 12), pt.writeUint32LE(a + c | 0, i, 16), pt.writeUint32LE(l + u | 0, i, 20), pt.writeUint32LE(L + d | 0, i, 24), pt.writeUint32LE(v + p | 0, i, 28), pt.writeUint32LE(R + b | 0, i, 32), pt.writeUint32LE($ + D | 0, i, 36), pt.writeUint32LE(q + x | 0, i, 40), pt.writeUint32LE(m + E | 0, i, 44), pt.writeUint32LE(_ + C | 0, i, 48), pt.writeUint32LE(B + F | 0, i, 52), pt.writeUint32LE(z + K | 0, i, 56), pt.writeUint32LE(j + I | 0, i, 60);
}
  ...
  var s = (
    ...
    function() {
      function o(c) {
        ...
        var D = c[8] | c[9] << 8;
        this._r[4] = (b >>> 4 | D << 12) & 255, this._r[5] = D >>> 1 & 8190;
        var x = c[10] | c[11] << 8;
      ...
      return o.prototype._blocks = function(c, u, d) {
        for (var p = this._fin ? 0 : 2048, b = this._h[0], D = this._h[1], x = this._h[2], E = this._h[3], C = this._h[4], F = this._h[5], K = this._h[6], I = this._h[7], O = this._h[8], y = this._h[9], w = this._r[0], f = this._r[1], a = this._r[2], l = this._r[3], L = this._r[4], v = this._r[5], R = this._r[6], $ = this._r[7], q = this._r[8], m = this._r[9]; d >= 16; ) {
          var _ = c[u + 0] | c[u + 1] << 8;
          b += _ & 8191;
          var B = c[u + 2] | c[u + 3] << 8;
          D += (_ >>> 13 | B << 3) & 8191;
          ...
          var G = 0, ie = G;
          ie += b * w, ie += D * (5 * m), ie += x * (5 * q), ie += E * (5 * $), ie += C * (5 * R), G = ie >>> 13, ie &= 8191, ie += F * (5 * v), ie += K * (5 * L), ie += I * (5 * l), ie += O * (5 * a), ie += y * (5 * f), G += ie >>> 13, ie &= 8191;
          var Q = G;
          Q += b * f, Q += D * w, Q += x * (5 * m), Q += E * (5 * q), Q += C * (5 * $), G = Q >>> 13, Q &= 8191, Q += F * (5 * R), Q += K * (5 * v), Q += I * (5 * L), Q += O * (5 * l), Q += y * (5 * a), G += Q >>> 13, Q &= 8191;
          var se = G;
          se += b * a, se += D * f, se += x * w, se += E * (5 * m), se += C * (5 * q), G = se >>> 13, se &= 8191, se += F * (5 * $), se += K * (5 * R), se += I * (5 * v), se += O * (5 * L), se += y * (5 * l), G += se >>> 13, se &= 8191;
          var T = G;
          T += b * l, T += D * a, T += x * f, T += E * w, T += C * (5 * m), G = T >>> 13, T &= 8191, T += F * (5 * q), T += K * (5 * $), T += I * (5 * R), T += O * (5 * v), T += y * (5 * L), G += T >>> 13, T &= 8191;
          var A = G;
          A += b * L, A += D * l, A += x * a, A += E * f, A += C * w, G = A >>> 13, A &= 8191, A += F * (5 * m), A += K * (5 * q), A += I * (5 * $), A += O * (5 * R), A += y * (5 * v), G += A >>> 13, A &= 8191;
          var N = G;
          N += b * v, N += D * L, N += x * l, N += E * a, N += C * f, G = N >>> 13, N &= 8191, N += F * w, N += K * (5 * m), N += I * (5 * q), N += O * (5 * $), N += y * (5 * R), G += N >>> 13, N &= 8191;
          var h = G;
          h += b * R, h += D * v, h += x * L, h += E * l, h += C * a, G = h >>> 13, h &= 8191, h += F * f, h += K * w, h += I * (5 * m), h += O * (5 * q), h += y * (5 * $), G += h >>> 13, h &= 8191;
          var S = G;
          S += b * $, S += D * R, S += x * v, S += E * L, S += C * l, G = S >>> 13, S &= 8191, S += F * a, S += K * f, S += I * w, S += O * (5 * m), S += y * (5 * q), G += S >>> 13, S &= 8191;
          var W = G;
          W += b * q, W += D * $, W += x * R, W += E * v, W += C * L, G = W >>> 13, W &= 8191, W += F * l, W += K * a, W += I * f, W += O * w, W += y * (5 * m), G += W >>> 13, W &= 8191;
          var X = G;
          X += b * m, X += D * q, X += x * $, X += E * R, X += C * v, G = X >>> 13, X &= 8191, X += F * L, X += K * l, X += I * a, X += O * f, X += y * w, G += X >>> 13, X &= 8191, G = (G << 2) + G | 0, G = G + ie | 0, ie = G & 8191, G = G >>> 13, Q += G, b = ie, D = Q, x = se, E = T, C = A, F = N, K = h, I = S, O = W, y = X, u += 16, d -= 16;
        }
        this._h[0] = b, this._h[1] = D, this._h[2] = x, this._h[3] = E, this._h[4] = C, this._h[5] = F, this._h[6] = K, this._h[7] = I, this._h[8] = O, this._h[9] = y;
      }, o.prototype.finish = function(c, u) {
        u === void 0 && (u = 0);
        var d = new Uint16Array(10), p, b, D, x;
        if (this._leftover) {
        ...
        for (d[9] -= 8192, b = (p ^ 1) - 1, x = 0; x < 10; x++)
          d[x] &= b;
        for (b = ~b, x = 0; x < 10; x++)
          this._h[x] = this._h[x] & b | d[x];
...
(function(i) {
  ...
  var o = new Uint8Array(16), c = (
    ...
    function() {
      ...
      return u.prototype.seal = function(d, p, b, D) {
        if (d.length > 16)
        ...
        if (D) {
          ...
          F = new Uint8Array(C);
        return e.streamXOR(this._key, x, p, F, 4), this._authenticate(F.subarray(F.length - this.tagLength, F.length), E, F.subarray(0, F.length - this.tagLength), b), s.wipe(x), F;
      }, u.prototype.open = function(d, p, b, D) {
        if (d.length > 16)
          throw new Error("ChaCha20Poly1305: incorrect nonce length");
        ...
        if (this._authenticate(C, E, p.subarray(0, p.length - this.tagLength), b), !n.equal(C, p.subarray(p.length - this.tagLength, p.length)))
          return null;
      ...
      }, u.prototype._authenticate = function(d, p, b, D) {
        var x = new t.Poly1305(p);
        D && (x.update(D), D.length % 16 > 0 && x.update(o.subarray(D.length % 16))), x.update(b), b.length % 16 > 0 && x.update(o.subarray(b.length % 16));
        var E = new Uint8Array(8);
        D && r.writeUint64LE(D.length, E), x.update(E), r.writeUint64LE(b.length, E), x.update(E);
...
(function(i) {
  ...
  var s = (
    ...
    function() {
      ...
      return c.prototype._initState = function() {
        ...
        if (!this._finished) {
          var d = this._bytesHashed, p = this._bufferLength, b = d / 536870912 | 0, D = d << 3, x = d % 64 < 56 ? 64 : 128;
          this._buffer[p] = 128;
          for (var E = p + 1; E < x - 8; E++)
            this._buffer[E] = 0;
          e.writeUint32BE(b, this._buffer, x - 8), e.writeUint32BE(D, this._buffer, x - 4), n(this._temp, this._state, this._buffer, 0, x), this._finished = !0;
        }
  ...
  function n(c, u, d, p, b) {
    for (; b >= 64; ) {
      ...
      u[0] += D, u[1] += x, u[2] += E, u[3] += C, u[4] += F, u[5] += K, u[6] += I, u[7] += O, p += 64, b -= 64;
    }
    return p;
  }
  function o(c) {
...
(function(i) {
  ...
  function D(y, w, f) {
    let a, l, L = 0, v = 0, R = 0, $ = 0, q = 0, m = 0, _ = 0, B = 0, z = 0, j = 0, U = 0, M = 0, H = 0, te = 0, G = 0, ie = 0, Q = 0, se = 0, T = 0, A = 0, N = 0, h = 0, S = 0, W = 0, X = 0, fe = 0, ve = 0, ge = 0, Se = 0, Me = 0, $e = 0, be = f[0], ye = f[1], pe = f[2], le = f[3], ue = f[4], he = f[5], ce = f[6], re = f[7], de = f[8], me = f[9], ne = f[10], _e = f[11], Ee = f[12], De = f[13], xe = f[14], Ie = f[15];
  ...
  function C(y, w) {
    ...
    for (let z = 254; z >= 0; --z) {
      const j = f[z >>> 3] >>> (z & 7) & 1;
      c(l, L, j), c(v, R, j), p($, l, v), b(l, l, v), p(v, L, R), b(L, L, R), x(R, $), x(q, l), D(l, v, l), D(v, L, $), p($, l, v), b(l, l, v), x(L, l), b(v, R, q), D(l, v, n), p(l, l, R), D(v, v, l), D(l, R, q), D(R, L, a), x(L, $), c(l, L, j), c(v, R, j);
    }
    for (let z = 0; z < 16; z++)
...
function Gf() {
  ...
  function t() {
    const b = i.getElementsByTagName("link"), D = [];
    for (let x = 0; x < b.length; x++) {
      const E = b[x], C = E.getAttribute("rel");
  ...
  function s(...b) {
    ...
    for (let x = 0; x < D.length; x++) {
      const E = D[x], C = ["itemprop", "property", "name"].map((F) => E.getAttribute(F)).filter((F) => F ? b.includes(F) : !1);
      if (C.length && C) {
...
(function(i) {
  ...
  function c(I) {
    switch (I.arrayFormat) {
      case "index":
        return (O) => (y, w) => {
          const f = y.length;
          return w === void 0 || I.skipNull && w === null || I.skipEmptyString && w === "" ? y : w === null ? [...y, [p(O, I), "[", f, "]"].join("")] : [
            ...y,
            [p(O, I), "[", p(f, I), "]=", p(w, I)].join("")
          ];
        };
      case "bracket":
        return (O) => (y, w) => w === void 0 || I.skipNull && w === null || I.skipEmptyString && w === "" ? y : w === null ? [...y, [p(O, I), "[]"].join("")] : [...y, [p(O, I), "[]=", p(w, I)].join("")];
      case "colon-list-separator":
        return (O) => (y, w) => w === void 0 || I.skipNull && w === null || I.skipEmptyString && w === "" ? y : w === null ? [...y, [p(O, I), ":list="].join("")] : [...y, [p(O, I), ":list=", p(w, I)].join("")];
      case "comma":
      case "separator":
      case "bracket-separator": {
        const O = I.arrayFormat === "bracket-separator" ? "[]=" : "=";
        return (y) => (w, f) => f === void 0 || I.skipNull && f === null || I.skipEmptyString && f === "" ? w : (f = f === null ? "" : f, w.length === 0 ? [[p(y, I), O, p(f, I)].join("")] : [[w, p(f, I)].join(I.arrayFormatSeparator)]);
      }
      default:
        return (O) => (y, w) => w === void 0 || I.skipNull && w === null || I.skipEmptyString && w === "" ? y : w === null ? [...y, p(O, I)] : [...y, [p(O, I), "=", p(w, I)].join("")];
    }
  }
  function u(I) {
    let O;
  ...
  function K(I, O) {
    ...
    const y = u(O), w = /* @__PURE__ */ Object.create(null);
    ...
    for (const f of I.split("&")) {
      ...
      l = l === void 0 ? null : ["comma", "separator", "bracket-separator"].includes(O.arrayFormat) ? l : b(l, O), y(b(a, O), l, w);
    }
    ...
    return O.sort === !1 ? w : (O.sort === !0 ? Object.keys(w).sort() : Object.keys(w).sort(O.sort)).reduce((f, a) => {
      const l = w[a];
  ...
  i.extract = C, i.parse = K, i.stringify = (I, O) => {
    ...
    const y = (l) => O.skipNull && n(I[l]) || O.skipEmptyString && I[l] === "", w = c(O), f = {};
    for (const l of Object.keys(I))
      y(l) || (f[l] = I[l]);
    const a = Object.keys(f);
    return O.sort !== !1 && a.sort(O.sort), a.map((l) => {
      const L = I[l];
      return L === void 0 ? "" : L === null ? p(l, O) : Array.isArray(L) ? L.length === 0 && O.arrayFormat === "bracket-separator" ? p(l, O) + "[]" : L.reduce(w(l), []).join("&") : p(l, O) + "=" + p(L, O);
    ...
    const y = x(I.url).split("?")[0] || "", w = i.extract(I.url), f = i.parse(w, { sort: !1 }), a = Object.assign(f, I.query);
    ...
    const w = Array.isArray(O) ? (f) => !O.includes(f) : (f, a) => !O(f, a);
    return i.pick(I, w, y);
  };
})(ii);
const Tc = {
...
function cp(i, e) {
  const t = Ws(i);
  return Lc({ type: ws(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? Ne(t.senderPublicKey, vt) : void 0, receiverPublicKey: e?.receiverPublicKey });
}
function Lc(i) {
  const e = i?.type || Uc;
  if (e === Di) {
...
function qp(i, e) {
  ...
  return _i(r, s) ? (s.forEach((o) => {
    ...
    (!_i($c(o, b), p) || !_i(b.methods, u) || !_i(b.events, d)) && (n = !1);
  }), n) : !1;
}
function Ys(i) {
...
function qo(i, e, t) {
  let s = null;
  const r = ng(i), n = og(e), o = Object.keys(r), c = Object.keys(n), u = jo(Object.keys(i)), d = jo(Object.keys(e)), p = u.filter((b) => !d.includes(b));
  return p.length && (s = Y("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
    ...
    if (!b.includes(":") || s)
      return;
    const D = Mi(e[b].accounts);
    D.includes(b) || (s = Y("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${b}
        Required: ${b}
        Approved: ${D.toString()}`));
  }), o.forEach((b) => {
...
const pg = "PARSE_ERROR", gg = "INVALID_REQUEST", yg = "METHOD_NOT_FOUND", mg = "INVALID_PARAMS", Bc = "INTERNAL_ERROR", bn = "SERVER_ERROR", bg = [-32700, -32600, -32601, -32602, -32603], hs = {
...
function Ig(i, e) {
  return typeof i > "u" ? Ko(Bc) : (typeof i == "string" && (i = Object.assign(Object.assign({}, Ko(bn)), { message: i })), typeof e < "u" && (i.data = e), wg(i.code) && (i = vg(i.code)), i);
}
class Gc {
}
class Dg extends Gc {
...
(function(i, e) {
  ...
  Q[q] = Q[m] = Q[_] = Q[B] = Q[z] = Q[j] = Q[U] = Q[M] = Q[H] = !0, Q[c] = Q[u] = Q[R] = Q[p] = Q[$] = Q[b] = Q[D] = Q[x] = Q[C] = Q[F] = Q[I] = Q[w] = Q[f] = Q[a] = Q[v] = !1;
  ...
  function pu(g, P, k, Z, Re, ae) {
    ...
    if (ft && !xt)
      return ae || (ae = new ri()), Le || Kn(g) ? Un(g, P, k, Z, Re, ae) : bu(g, P, ct, k, Z, Re, ae);
    if (!(k & r)) {
    ...
    return ft ? (ae || (ae = new ri()), wu(g, P, k, Z, Re, ae)) : !1;
  }
  function gu(g) {
    if (!zn(g) || Iu(g))
      return !1;
...
function Ug(i, e) {
  ...
  return { encode: b, decodeUnsafe: D, decode: x };
}
var Lg = Ug, Mg = Lg;
const Qc = (i) => {
  if (i instanceof Uint8Array && i.constructor.name === "Uint8Array")
...
const Xo = { ...Wg, ...Jg, ...Xg, ...ey, ...sy, ...fy, ...yy, ...wy, ...Iy, ...Ry };
({ ...Xy, ...i1 });
function oh(i) {
  return globalThis.Buffer != null ? new Uint8Array(i.buffer, i.byteOffset, i.byteLength) : i;
}
...
let $1 = class {
  ...
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new We.EventEmitter(), this.name = y1, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = V.toMiliseconds(V.TEN_SECONDS), this.needsTransportRestart = !1, this.publish = async (s, r, n) => {
      ...
      try {
        const c = n?.ttl || g1, u = Gr(n), d = n?.prompt || !1, p = n?.tag || 0, b = n?.id || vn().toString(), D = { topic: s, message: r, opts: { ttl: c, relay: u, prompt: d, tag: p, id: b } }, x = setTimeout(() => this.queue.set(b, D), this.publishTimeout);
        try {
          await await ds(this.rpcPublish(s, r, c, u, d, p, b), this.publishTimeout, "Failed to publish payload, please try again."), this.removeRequestFromQueue(b), this.relayer.events.emit(gt.publish, D);
        } catch (E) {
          if (this.logger.debug("Publishing Payload stalled"), this.needsTransportRestart = !0, (o = n?.internal) != null && o.throwOnFailedPublish)
            throw this.removeRequestFromQueue(b), E;
          return;
        } finally {
          clearTimeout(x);
        }
  ...
  rpcPublish(e, t, s, r, n, o, c) {
    ...
    return bt((u = D.params) == null ? void 0 : u.prompt) && ((d = D.params) == null || delete d.prompt), bt((p = D.params) == null ? void 0 : p.tag) && ((b = D.params) == null || delete b.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: D }), this.relayer.request(D);
  }
...
let Y1 = class extends ml {
  ...
  async createProvider() {
    ...
    this.provider = new _n(new Yc(wp({ sdkVersion: _1, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e, useOnCloseEvent: !0 }))), this.registerProviderListeners();
  }
...
var pm = Object.defineProperty, gm = Object.defineProperties, ym = Object.getOwnPropertyDescriptors, pa = Object.getOwnPropertySymbols, mm = Object.prototype.hasOwnProperty, bm = Object.prototype.propertyIsEnumerable, ga = (i, e, t) => e in i ? pm(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t, Et = (i, e) => {
  for (var t in e || (e = {}))
    mm.call(e, t) && ga(i, t, e[t]);
  if (pa)
    for (var t of pa(e))
      bm.call(e, t) && ga(i, t, e[t]);
  return i;
}, ts = (i, e) => gm(i, ym(e));
let wm = class extends Sl {
  constructor(e) {
    super(e), this.name = lm, this.events = new tr(), this.initialized = !1, this.ignoredPayloadTypes = [Di], this.requestQueue = { state: ei.idle, queue: [] }, this.sessionRequestQueue = { state: ei.idle, queue: [] }, this.requestQueueDelay = V.ONE_SECOND, this.init = async () => {
      ...
      const C = Et({ relay: { protocol: r ?? "irn" }, namespaces: n, requiredNamespaces: p, optionalNamespaces: b, pairingTopic: u, controller: { publicKey: D, metadata: this.client.metadata }, expiry: Mt(Fs) }, o && { sessionProperties: o });
      ...
      return this.events.once(Be("session_request", c), ({ error: b, result: D }) => {
        b ? p(b) : d(D);
      }), await Promise.all([new Promise(async (b) => {
        await this.sendRequest({ clientRpcId: c, topic: n, method: "wc_sessionRequest", params: { request: r, chainId: s }, expiry: o, throwOnFailedPublish: !0 }).catch((D) => p(D)), this.client.events.emit("session_request_sent", { topic: n, request: r, chainId: s, id: c }), b();
      }), new Promise(async (b) => {
        const D = await this.client.core.storage.getItem(fa);
        Ep({ id: c, topic: n, wcDeepLink: D }), b();
      }), u()]).then((b) => b[2]);
      ...
      const b = await this.client.core.crypto.encode(s, p), D = es[r].req;
      return o && (D.ttl = o), c && (D.id = c), this.client.core.history.set(s, p), d ? (D.internal = ts(Et({}, D.internal), { throwOnFailedPublish: !0 }), await this.client.core.relayer.publish(s, b, D)) : this.client.core.relayer.publish(s, b, D).catch((x) => this.client.logger.error(x)), p.id;
      ...
      try {
        ...
        const { relay: o, controller: c, expiry: u, namespaces: d, requiredNamespaces: p, optionalNamespaces: b, sessionProperties: D, pairingTopic: x } = s.params, E = Et({ topic: t, relay: o, expiry: u, namespaces: d, acknowledged: !0, pairingTopic: x, requiredNamespaces: p, optionalNamespaces: b, controller: c.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: c.publicKey, metadata: c.metadata } }, D && { sessionProperties: D });
...
class Nm {
  ...
  showModal(e) {
    if (clearTimeout(this.closingTimeout), (this.overlay || this.popupWindow) && this.close(), Us === "android" || Us === "ios") {
      ...
      n.setAttribute("href", e[Us]), n.setAttribute("target", "_blank"), n.click();
      return;
    }
    if (this.type === "window") {
...
const kt = new Nm(), Qs = Lr.NetworkName, Pm = async ({
  ...
  }, D = await Sm.init(b), x = new p({ client: D, chainId: e, rpcUrl: r });
  ...
  try {
    ...
    console.error("@argent/login::error"), kt.closeModal();
  }
}, Rm = (i) => {
  if (!i)
    throw new Error(
...
const mh = "base10", _t = "base16", Jr = "base64pad", Dn = "utf8", bh = 0, Ni = 1, Qm = 0, ya = 1, Qr = 12, xn = 32;
function Xm() {
  const i = ms.generateKeyPair();
...
function ib(i) {
  const e = tb(typeof i.type < "u" ? i.type : bh);
...
function nb(i, e) {
  const t = Xs(i);
  return wh({ type: Is(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? Ne(t.senderPublicKey, _t) : void 0, receiverPublicKey: e?.receiverPublicKey });
}
function wh(i) {
  const e = i?.type || bh;
  if (e === Ni) {
...
var ob = Object.defineProperty, ba = Object.getOwnPropertySymbols, ab = Object.prototype.hasOwnProperty, cb = Object.prototype.propertyIsEnumerable, wa = (i, e, t) => e in i ? ob(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t, va = (i, e) => {
  for (var t in e || (e = {}))
    ab.call(e, t) && wa(i, t, e[t]);
  if (ba)
    for (var t of ba(e))
      cb.call(e, t) && wa(i, t, e[t]);
  return i;
};
...
var _b = Object.defineProperty, _a = Object.getOwnPropertySymbols, Eb = Object.prototype.hasOwnProperty, Sb = Object.prototype.propertyIsEnumerable, Ea = (i, e, t) => e in i ? _b(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t, Ib = (i, e) => {
  for (var t in e || (e = {}))
    Eb.call(e, t) && Ea(i, t, e[t]);
  if (_a)
    for (var t of _a(e))
      Sb.call(e, t) && Ea(i, t, e[t]);
  return i;
};
function Db(i, e = "-") {
  const t = {}, s = "relay" + e;
...
function Da(i, e, t) {
  let s = null;
  const r = iw(i), n = sw(e), o = Object.keys(r), c = Object.keys(n), u = xa(Object.keys(i)), d = xa(Object.keys(e)), p = u.filter((b) => !d.includes(b));
  return p.length && (s = J("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
    ...
    if (!b.includes(":") || s)
      return;
    const D = zi(e[b].accounts);
    D.includes(b) || (s = J("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${b}
        Required: ${b}
        Approved: ${D.toString()}`));
  }), o.forEach((b) => {
...
const Nh = (i, e) => new dw({ ...i.decoders || { [i.prefix]: i }, ...e.decoders || { [e.prefix]: e } });
class fw {
  constructor(e, t, s, r) {
...
const dr = ({ name: i, prefix: e, encode: t, decode: s }) => new fw(i, e, t, s), xs = ({ prefix: i, name: e, alphabet: t }) => {
  ...
  return pw(r, s, t, i);
} }), yw = dr({ prefix: "\0", name: "identity", encode: (i) => hw(i), decode: (i) => cw(i) });
...
const Ph = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂"), Ww = Ph.reduce((i, e, t) => (i[t] = e, i), []), Yw = Ph.reduce((i, e, t) => (i[e.codePointAt(0)] = t, i), []);
function Jw(i) {
...
const Xw = dr({ prefix: "🚀", name: "base256emoji", encode: Jw, decode: Qw });
var Zw = Object.freeze({ __proto__: null, base256emoji: Xw }), e0 = Rh, Oa = 128, t0 = 127, i0 = ~t0, s0 = Math.pow(2, 31);
function Rh(i, e, t) {
  e = e || [], t = t || 0;
  for (var s = t; i >= s0; )
    e[t++] = i & 255 | Oa, i /= 128;
...
const Ah = ({ name: i, code: e, encode: t }) => new b0(i, e, t);
class b0 {
  constructor(e, t, s) {
    this.name = e, this.code = t, this.encode = s;
  }
...
const Th = (i) => async (e) => new Uint8Array(await crypto.subtle.digest(i, e)), w0 = Ah({ name: "sha2-256", code: 18, encode: Th("SHA-256") }), v0 = Ah({ name: "sha2-512", code: 19, encode: Th("SHA-512") });
...
new TextEncoder(), new TextDecoder();
const Ca = { ...mw, ...ww, ..._w, ...Sw, ...xw, ...Uw, ...qw, ...Kw, ...Gw, ...Zw };
({ ..._0, ...D0 });
function Uh(i) {
  return globalThis.Buffer != null ? new Uint8Array(i.buffer, i.byteOffset, i.byteLength) : i;
}
...
class nv extends Fm {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new We.EventEmitter(), this.name = q0, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = 1e4, this.publish = async (s, r, n) => {
      ...
      try {
        ...
        this.queue.set(p, b);
        try {
          await await Zs(this.rpcPublish(s, r, o, c, u, d, p), this.publishTimeout), this.relayer.events.emit(He.publish, b);
        } catch {
  ...
  rpcPublish(e, t, s, r, n, o, c) {
    ...
    return wt((u = D.params) == null ? void 0 : u.prompt) && ((d = D.params) == null || delete d.prompt), wt((p = D.params) == null ? void 0 : p.tag) && ((b = D.params) == null || delete b.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: D }), this.relayer.request(D);
  }
  onPublish(e) {
    this.queue.delete(e);
  }
...
class mv extends Um {
  ...
  async createProvider() {
    const e = await this.core.crypto.signJWT(this.relayUrl);
    this.provider = new _n(new Yc(mb({ sdkVersion: B0, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e, useOnCloseEvent: !0 }))), this.registerProviderListeners();
  }
  async recordMessageEvent(e) {
    const { topic: t, message: s } = e;
    await this.messages.set(t, s);
...
var bv = Object.defineProperty, qa = Object.getOwnPropertySymbols, wv = Object.prototype.hasOwnProperty, vv = Object.prototype.propertyIsEnumerable, ja = (i, e, t) => e in i ? bv(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t, za = (i, e) => {
  for (var t in e || (e = {}))
    wv.call(e, t) && ja(i, t, e[t]);
  if (qa)
    for (var t of qa(e))
...
class _v {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = J0, this.version = Q0, this.events = new tr(), this.initialized = !1, this.storagePrefix = ui, this.ignoredPayloadTypes = [Ni], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const s = Xr(), r = await this.core.crypto.setSymKey(s), n = Ht(V.FIVE_MINUTES), o = { protocol: qh }, c = { topic: r, expiry: n, relay: o, active: !1 }, u = Pb({ protocol: this.core.protocol, version: this.core.version, topic: r, symKey: s, relay: o });
      return await this.pairings.set(r, c), await this.core.relayer.subscribe(r), this.core.expirer.set(r, n), { topic: r, uri: u };
    }, this.pair = async (s) => {
      this.isInitialized(), this.isValidPair(s);
    ...
    super(e), this.name = Tv, this.events = new tr(), this.initialized = !1, this.ignoredPayloadTypes = [Ni], this.init = async () => {
      ...
      if (this.events.once(ke("session_connect"), async ({ error: O, session: y }) => {
        if (O)
          ...
          y.self.publicKey = D;
          const w = Ur(At({}, y), { requiredNamespaces: y.requiredNamespaces, optionalNamespaces: y.optionalNamespaces });
          await this.client.session.set(y.topic, w), await this.setExpiry(y.topic, y.expiry), d && await this.client.core.pairing.updateMetadata({ topic: d, metadata: y.peer.metadata }), C(w);
        }
      }), !d) {
      ...
      const C = At({ relay: { protocol: r ?? "irn" }, namespaces: n, requiredNamespaces: p, optionalNamespaces: b, pairingTopic: u, controller: { publicKey: D, metadata: this.client.metadata }, expiry: Ht(Ls) }, o && { sessionProperties: o });
      ...
      return this.events.once(ke("session_request", c), ({ error: b, result: D }) => {
        b ? p(b) : d(D);
      ...
      try {
        this.isValidSessionSettleRequest(n);
        const { relay: o, controller: c, expiry: u, namespaces: d, requiredNamespaces: p, optionalNamespaces: b, sessionProperties: D, pairingTopic: x } = s.params, E = At({ topic: t, relay: o, expiry: u, namespaces: d, acknowledged: !0, pairingTopic: x, requiredNamespaces: p, optionalNamespaces: b, controller: c.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: c.publicKey, metadata: c.metadata } }, D && { sessionProperties: D });
...
class Tn extends zm {
  constructor(e) {
    ...
    }, this.name = e?.name || $r.name, this.metadata = e?.metadata || fb();
